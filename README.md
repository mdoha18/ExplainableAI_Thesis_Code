In addition to Jacob Gil's code I added the ML Model code used in my thesis (for 2D CNN) and the code to make plots and save results of faithfullness computations.
